                ...
                <form action="{{ route('requerente.store') }}" method="POST" autocomplete="off" id="formcadastrorequerente">
                    ...
                    <div class="mb-2 row">
                        ...
                        <div class="col-sm-2">
                            <div style="margin-top: 10px;">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="possuiparenteporeminviavelcompartilhardomicilio" id="possuiparenteporeminviavelcompartilhardomiciliosim" value="1" {{old('possuiparenteporeminviavelcompartilhardomicilio') == '1' ? 'checked' : ''}}>
