...
Olá {{ $dados['nome']}}!<br>
Você foi cadastrado(a) para acessar o <strong>Sistema Aluguel Maria da Penha</strong>, da Secretaria de Estado da Mulher / SEMU, com o perfil de <strong>"{{ $dados['perfil']}}"</strong> do Sistema.<br><br>
