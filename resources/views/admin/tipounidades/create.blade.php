...
@section('content')
    <div class="container-fluid px-4">
        <div class="mb-1 hstack gap-2">
            <h2 class="mt-3">Cadastrar Tipo de Unidade</h2>
        ...
        <div class="card mb-4 border-light shadow">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('tipounidade.store') }}" method="POST" autocomplete="off">
                    @csrf
                    @method('POST')
                    ...
                    <div class="row">
                        ...
                        <div class="col-2">
                            <div class="form-group focused">
                                ...
                                <input type="text" class="form-control" id="nome" name="nome" value="{{old('nome')}}" placeholder="Tipo de Unidade" required >
                                @error('nome')
                        ...
                        <div class="col-5">
                            <div class="form-group focused">
                                ...
                                <input type="text" class="form-control" id="descricao" name="descricao" value="{{old('descricao')}}" placeholder="Descrição da Unidade" required >
                                @error('descricao')
                                    <small style="color: red">{{$message}}</small>
                                @enderror
                            </div>
