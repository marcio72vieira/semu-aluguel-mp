...
class RequerenteRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'comunidade'            => 'required',
            'outracomunidade'       => 'required_if:comunidade,==,"8"',
            'racacor'               => 'required',
            'outraracacor'          => 'required_if:racacor,==,"7"',
            'identidadegenero'      => 'required',
            'outraidentidadegenero' => 'required_if:identidadegenero,==,"5"',
            'orientacaosexual'      => 'required',
            'outraorientacaosexual' => 'required_if:orientacaosexual,==,"4"',
            'deficiente'            => 'required',
